...
/**
 * Information about the current PalyrimOS build, extracted from system properties.
 */
public class Build {
    ...
    public static final String PALYRIM_VERSION = getString("ro.palyrim.version");

    /** A build ID string meant for displaying to the user */
    public static final String PALYRIM_DISPLAY_VERSION = getString("ro.palyrim.display.version");
    ...
    public static class LINEAGE_VERSION_CODES {
        ...
        /**
         * February 2018: Unreleased preliminary version starting from PalyrimOS 15.1
         * <p>Unused APIs have been removed.</p>
         */
        public static final int HACKBERRY = 8;

        /**
         * March 2018: The 1st iteration of the platform sdk for PalyrimOS
         * <p>Applications targeting this or a later version will get access to these
         * new features!</p>
         * <ul>
